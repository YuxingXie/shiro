...
## Shiro 拦截器机制 <a id='#ccp9'>目录</a>

### 拦截器机制 <a id='#ccp9-1'>目录</a>
...
![](https://github.com/YuxingXie/shiro/raw/master/doc/notice.png)(注:以下方法表示方法签名，AdviceFilter虽然是抽象类，但下列方法不是抽象方法)
